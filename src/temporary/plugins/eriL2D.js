async function initialize() {
  try {
    ...
    console.warn = (...input) => log.warn("xd", input);

    plugin();
    window.__KAEDE__.libs.Logging.log.info("xd", "Eri Live 2D");
  } catch (error) {
    window.__KAEDE__.libs.Logging.log.error("xd", "Error:", window.__KAEDE__.libs.Errors.prettify(error));
  }
}
